...
class BookingNetworkException implements Exception {
  final String message;

  const BookingNetworkException(this.message);
...
class BookingService {
  ...
  BookingService({String? baseUrl}) : _baseUrl = baseUrl ?? AppConfig.baseUrl;
  ...
  Future<bool> createBooking({
    ...
    print(
      'BookingService: Creating booking at $url with startDate=$startDate, endDate=$sanitizedEndDate',
    );
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        print('BookingService: $_lastError');
        throw BookingApiException(response.statusCode, _lastError!);
      }
      ...
      throw BookingNetworkException(_lastError!);
    } catch (e, stackTrace) {
